<!-- START: Sidebar -->
<aside class="fixed z-30 w-[360px] bg-stream-dark">
    <style>
        .custom-scroll::-webkit-scrollbar {
            width: 0 !important;
        }
    </style>
    <div class="flex flex-col p-12 border-r border-softpur overflow-hidden h-screen custom-scroll overflow-y-auto">
        <a href="/">
