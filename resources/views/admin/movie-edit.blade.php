        ...
        <form enctype="multipart/form-data" method="POST" action="{{ route('admin.movie.update', $movie->id) }}">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="{{ $movie->casts }}" id="casts" name="casts" placeholder="Jackie Chan">
            </div>
            <div class="form-group">
              <label for="categories">Categories</label>
              <input type="text" class="form-control" value="{{ $movie->categories }}" id="categories" name="categories" placeholder="Action, Fantasy">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="{{ $movie->short_about }}" id="short_about" name="short_about" placeholder="Awesome Movie">
            </div>
            <div class="form-group">
              <label for="short-about">About</label>
              <input type="text" class="form-control" value="{{ $movie->about }}" id="about" name="about" placeholder="Awesome Movie">
            </div>
            <div class="form-group">
