                    ...
                    <table id="movie" class="table table-bordered table-hover">
                        <thead>
                          <tr>
                            <th>Id</th>
                            <th>Title</th>
                            <th>Small Tumbnail</th>
                            <th>Large Tumbnail</th>
                            <th>Categories</th>
                            <th>Casts</th>
                            <th>Action</th>
                          </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $movie->title }}</td>
                                <td>
                                    <img src="{{ asset('storage/tumbnail/'.$movie->small_tumbnail) }}" width="50%">
                                </td>
                                <td>
                                    <img src="{{ asset('storage/tumbnail/'.$movie->large_tumbnail) }}" width="50%">
                                </td>
